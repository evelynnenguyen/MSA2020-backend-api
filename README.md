...
![Create app](.img/Create%20%281%29.png)
Give your project a name
![project name](.img/Create%20%282%29.png)
Select API -> Click Create
![Api](.img/Create%20%283%29.png)
...
![run api](.img/Create%20%284%29.png)
![output json](.img/Create%20%285%29.png)
...
![delete default](.img/Create%20%287%29.png)
...
![model](.img/Create%20%2810%29.png)
Right click the Models folder and select add new item
![add item](.img/Create%20%2811%29.png)
...
```
![model code](.img/Create%20%2812%29.png)
...
![fix using snippet](.img/Create%20%2813%29.png)
![fix using snippet](.img/Create%20%2814%29.png)
...
```
![Context](.img/Create%20%2815%29.png)
![Context](.img/Create%20%2816%29.png)
...
```
![conn string add](.img/Create%20%2817%29.png)
...
![add-migrations](.img/Create%20%2818%29.png)
![add-migrations](.img/Create%20%2819%29.png)
...
![table updated](.img/Create%20%2820%29.png)
...
![scaffolding nav](.img/Create%20%2821%29.png)
![Api controller with](.img/Create%20%2822%29.png)
![model and context](.img/Create%20%2823%29.png)
![results](.img/Create%20%2824%29.png)
...
![edit post](.img/Create%20%2826%29.png)
...
![response](.img/Create%20%2827%29.png)
...
```
![migration update](.img/Create%20%2830%29.png)
